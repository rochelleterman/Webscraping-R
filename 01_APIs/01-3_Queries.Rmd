...
You can even try it out [here](https://developer.nytimes.com/get-started).
...
That's great. But we only have 10 items. The original response said we had 168 hits! Which means we have to make 150 /10, or 15 requests to get them all. Sounds like a job for iteration!
